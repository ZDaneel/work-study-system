...
CREATE TABLE `application` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='应聘表\n一对一学生申请，一对多用工计划';
...
INSERT INTO `assessment` VALUES (1,'2023','07',2,'2023-06-26 11:12:38','2023-06-26 20:24:05',25,20,20,20,15,100,22),(2,'2023','06',2,'2023-06-26 14:26:50','2023-06-26 20:24:05',23,18,18,17,12,88,22),(3,'2023','05',2,'2023-06-26 20:46:39','2023-06-26 20:46:39',23,20,20,19,13,95,20),(4,'2023','06',3,'2023-06-26 22:04:05','2023-06-26 22:04:05',23,20,19,19,15,96,20),(5,'2023','06',5,'2023-06-26 22:15:32','2023-06-26 22:15:32',22,18,18,19,13,90,18),(6,'2023','06',7,'2023-06-26 23:28:31','2023-06-26 23:28:31',24,20,19,20,15,98,20),(7,'2023','06',8,'2023-06-26 23:28:51','2023-06-26 23:28:51',20,15,18,18,15,86,15);
...
INSERT INTO `employment_job` VALUES (1,1,1,4,4),(2,1,2,2,1),(3,2,4,5,2),(4,2,5,3,3),(5,2,6,2,1);
...
CREATE TABLE `student` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student_job` VALUES (1,1,1),(2,2,3),(3,3,4),(4,3,5),(5,4,1),(6,4,7),(7,1,3),(8,1,2),(9,2,8),(10,5,3),(11,5,5),(12,5,2),(13,6,1),(14,6,2),(15,6,3),(16,7,1),(17,7,4),(18,7,5),(19,8,1),(20,8,2),(21,8,3),(22,8,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=257 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-26 23:51:55
